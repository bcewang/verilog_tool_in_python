...
class NodeTypeDict:
    ...
    node_dict["NODE_BLK_MODULE_PORT_EXP"] = node_dict["NODE_BLK_MODULE_LIST"] + 1
    node_dict["NODE_BLK_MODULE_PORT_EXP_DIR"] = node_dict["NODE_BLK_MODULE_PORT_EXP"] + 1
    node_dict["NODE_BLK_MODULE_PORT_EXP_TYPE"] = node_dict["NODE_BLK_MODULE_PORT_EXP_DIR"] + 1
    node_dict["NODE_BLK_MODULE_PORT_EXP_WIDTH"] = node_dict["NODE_BLK_MODULE_PORT_EXP_TYPE"] + 1
    node_dict["NODE_BLK_MODULE_PORT_EXP_NAME"] = node_dict["NODE_BLK_MODULE_PORT_EXP_WIDTH"] + 1
    node_dict["NODE_BLK_MODULE_CONTENT"] = node_dict["NODE_BLK_MODULE_PORT_EXP_NAME"] + 1
    ...
    node_dict["NODE_BLK_SUBMODULE_PARAM"] = node_dict["NODE_BLK_SUBMODULE_SOURCE"] + 1
    node_dict["NODE_BLK_SUBMODULE_PARAM_CONNECT"] = node_dict["NODE_BLK_SUBMODULE_PARAM"] + 1
    node_dict["NODE_BLK_SUBMODULE_PARAM_CONNECT_EXP"] = node_dict["NODE_BLK_SUBMODULE_PARAM_CONNECT"] + 1
    node_dict["NODE_BLK_SUBMODULE_PARAM_CONNECT_EXP_NAME"] = node_dict["NODE_BLK_SUBMODULE_PARAM_CONNECT_EXP"] + 1
    node_dict["NODE_BLK_SUBMODULE_PARAM_CONNECT_EXP_VALUE"] = node_dict["NODE_BLK_SUBMODULE_PARAM_CONNECT_EXP_NAME"] + 1
    node_dict["NODE_BLK_SUBMODULE_IO_CONNECT"] = node_dict["NODE_BLK_SUBMODULE_PARAM_CONNECT_EXP_VALUE"] + 1
    node_dict["NODE_BLK_SUBMODULE_IO_CONNECT_EXP"] = node_dict["NODE_BLK_SUBMODULE_IO_CONNECT"] + 1
    node_dict["NODE_BLK_SUBMODULE_IO_CONNECT_EXP_NAME"] = node_dict["NODE_BLK_SUBMODULE_IO_CONNECT_EXP"] + 1
    node_dict["NODE_BLK_SUBMODULE_IO_CONNECT_EXP_VALUE"] = node_dict["NODE_BLK_SUBMODULE_IO_CONNECT_EXP_NAME"] + 1
    node_dict["NODE_EXP_IF"] = node_dict["NODE_BLK_SUBMODULE_IO_CONNECT_EXP_VALUE"] + 1
    ...
    node_dict["NODE_EXP_FACTOR"] = node_dict["NODE_EXP_VECTOR"] + 1
    node_dict["NODE_EXP_NUMBER"] = node_dict["NODE_EXP_FACTOR"] + 1
    ...
    node_dict["NODE_EXP_OPERATOR"] = node_dict["NODE_EXP_KEYUNIT"] + 1
    node_dict["NODE_EXP_NAME"] = node_dict["NODE_EXP_OPERATOR"] + 1
    ...
    node_dict["NODE_EXP_SIGNAL_TYPE_NAME"] = node_dict["NODE_EXP_SIGNAL_TYPE"] + 1
    node_dict["NODE_EXP_SIGNAL_TYPE_WIDTH"] = node_dict["NODE_EXP_SIGNAL_TYPE_NAME"] + 1
    node_dict["NODE_EXP_SIGNAL_IDENTIFIER"] = node_dict["NODE_EXP_SIGNAL_TYPE_WIDTH"] + 1
    node_dict["NODE_EXP_KEYTYPE"] = node_dict["NODE_EXP_SIGNAL_TYPE_WIDTH"] + 1
